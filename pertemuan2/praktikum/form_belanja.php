        ...
        <div class="container px-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        ...
                        <label name="jamtangan" for="jamtangan" class="custom-control-label">Jam Tangan</label>
                    </div>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <div class="offset-4 col-8">
                    <input submit="submit" type="submit" name="submit" value="Submit" class="btn btn-primary">
                </div>
            </div>
